...
(doom! :input
       ...
       (vertico +icons +prescient +fuzzy)           ; the search engine of the future
       ...
       ;;(meow +qwerty)      ; file-templates    ; auto-snippets for empty files
       ...
       (rust +lsp + rustic)              ; Fe2O3.unwrap().unwrap().unwrap().unwrap()
       ;;scala             ; java, but good
